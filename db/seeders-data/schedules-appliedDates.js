module.exports = [
  {
    scheduleCode: "test-venue-monday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-thursday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-friday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-saturday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-sunday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-tuesday",
    appliedDates: JSON.stringify([
  ...
  {
    scheduleCode: "test-venue-schedule-monday",
    appliedDates: JSON.stringify([
      "2021-01-04T00:00:00.000Z",
  ...
  {
    scheduleCode: "test-venue-schedule-tuesday",
    appliedDates: JSON.stringify(["2021-01-05T00:00:00.000Z"]),
    dateOfApply: new Date(),
  },
  {
    scheduleCode: "test-venue-dbb-monday",
    appliedDates: JSON.stringify([
